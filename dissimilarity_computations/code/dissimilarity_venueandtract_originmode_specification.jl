...
CSV.write(string(path_output,"dissimilarity_index_",geographic_level,"_",originmode,"_",specification,".csv"),data_dissimilarity_venue_level)
CSV.write(string(path_output,"dissimilarity_index_pairwise_",geographic_level,"_",originmode,"_",specification,".csv"),data_dissimilarity_pairwise_venue_level)
...
CSV.write(string(path_output,"dissimilarity_index_",geographic_level,"_",originmode,"_",specification,".csv"),data_dissimilarity_tract_level)
CSV.write(string(path_output,"dissimilarity_index_pairwise_",geographic_level,"_",originmode,"_",specification,".csv"),data_dissimilarity_pairwise_tract_level)

...
syntax, [nestid(string)] [cuisinetype_midaggregate] [vehicle_avail_hhshare_diff]
...
covariates_racespecific, command(keep) `nest_id' `d_cuisine_m' `vehicle_avail_hhshare_diff' `spatial_income' `spatial_age' `spatial_gender'
covariates_racespecific, command(order) `nest_id' `d_cuisine_m' `vehicle_avail_hhshare_diff' `spatial_income' `spatial_age' `spatial_gender'

...
###############################################
# Counterfactual 2ndAve
###############################################

cftl = "2ndAve"

####
data_geoid11_home_pair = read_stata(string(path_input,"tract_pairs_",cftl,".dta"))
...
save(string(path_output,"geoid11_home_pair_",cftl,".jld"),"data_geoid11_home_pair",data_geoid11_home_pair,compress = true)
####

####
data_geoid11_work_pair = read_stata(string(path_input,"tract_pairs_",cftl,".dta"))
...
save(string(path_output,"geoid11_work_pair_",cftl,".jld"),"data_geoid11_work_pair",data_geoid11_work_pair,compress = true)
####
...
save(string(path_output,"geoid11_home_work_",cftl,".jld"),"data_geoid11_home_work",data_geoid11_home_work,compress = true)
####

###############################################
# Counterfactual slowdown
###############################################

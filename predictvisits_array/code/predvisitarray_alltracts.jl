...
@everywhere path_output = "../output/predictedvisitsarray/"
...
@everywhere data_geoid11_home_pair = load(string(path_input,"geoid11_home_pair.jld"))["data_geoid11_home_pair"]
@everywhere data_geoid11_work_pair = load(string(path_input,"geoid11_work_pair.jld"))["data_geoid11_work_pair"]
@everywhere data_geoid11_home_work = load(string(path_input,"geoid11_home_work.jld"))["data_geoid11_home_work"]
...
save(string(path_output,"predvisitarray_",tr,".jld"),"predvisitarray",temp,compress = true)
end
,list_tract)

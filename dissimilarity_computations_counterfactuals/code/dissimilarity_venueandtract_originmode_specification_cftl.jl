...
#Arguments
originmode_temp = ARGS[1]
specification_temp = ARGS[2]
cftl_temp = ARGS[3]

for i in procs()
  @spawnat i global const originmode = originmode_temp
  @spawnat i global const specification = specification_temp
...
@everywhere data_prob_venue_cond_black_home = load(string(path_prob_venue_cond_race_home,"predictedvisits_collapsed_over_workplace_","black","_",originmode,"_",specification,"_",cftl,".jld"))["predvisit"]
@everywhere data_prob_venue_cond_asian_home = load(string(path_prob_venue_cond_race_home,"predictedvisits_collapsed_over_workplace_","asian","_",originmode,"_",specification,"_",cftl,".jld"))["predvisit"]
@everywhere data_prob_venue_cond_whithisp_home = load(string(path_prob_venue_cond_race_home,"predictedvisits_collapsed_over_workplace_","whithisp","_",originmode,"_",specification,"_",cftl,".jld"))["predvisit"]
...
CSV.write(string(path_output,"dissimilarity_index_",geographic_level,"_",originmode,"_",specification,"_",cftl,".csv"),data_dissimilarity_venue_level)
CSV.write(string(path_output,"dissimilarity_index_pairwise_",geographic_level,"_",originmode,"_",specification,"_",cftl,".csv"),data_dissimilarity_pairwise_venue_level)
...
CSV.write(string(path_output,"dissimilarity_index_",geographic_level,"_",originmode,"_",specification,"_",cftl,".csv"),data_dissimilarity_tract_level)
CSV.write(string(path_output,"dissimilarity_index_pairwise_",geographic_level,"_",originmode,"_",specification,"_",cftl,".csv"),data_dissimilarity_pairwise_tract_level)
